...
train = pd.read_csv("D:\Kaggle\RossmannSales\RandomForest\train.csv")
test = pd.read_csv("D:\Kaggle\RossmannSales\RandomForest\test.csv")
store = pd.read_csv("D:\Kaggle\RossmannSales\RandomForest\store.csv")
